...
/*
	...
	** File: user-access-history.php 
	** Endpoint: user/access-history
	** Name: User -> User Access History 
	** Description: All of your user access history related to logging in via bottpoker.com
...
$result = $obj->user_access_history($post);

################
# EXECUTE using send(); Provide the name of the endpoint `user/access-history` 
