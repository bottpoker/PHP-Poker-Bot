...
/*
	...
	** File: withdraw-list.php 
	** Endpoint: withdraw/list
	** Name: Withdraw -> Withdraw List 
	** Description: All of your accounts withdraw requests and related `status` and `id` information
...
$result = $obj->withdraw_list($post);

################
# EXECUTE using send(); Provide the name of the endpoint `withdraw/list` 
